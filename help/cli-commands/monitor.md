...
The monitor command creates a project in your Synk account to be continuously monitored for open source vulnerabilities and license issues. After running this command, log in to the Snyk website and view your projects to see the monitor.
...
Specify the <ORG_NAME>, that is, an organization in your Snyk account, to run Snyk commands tied to a specific organization. The Organization ID also influences some features availability and private test limits.
